...
const ExerciseAdvisor = () => {
  const predefinedExercises = [
    ...
    },
    {
      ...
      instructions: "Resistance bands are stretchy strips of rubber that add resistance to workouts with reduced stress on your body. Resistance band workouts are user-friendly, and accessible for beginners.",
      ageGroup: "senior",
    },
        ...
        {predefinedExercises.map((exercise, index) => (
          <div key={index} className="exercise-card">
            ...
            <img
              ...
              alt={`Exercise ${exercise.title} Image`}
            />
          </div>
        ))}
      </div>
